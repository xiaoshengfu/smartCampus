...
<html lang="zh-CN">
  <head>
	...
	<script type="text/javascript">
		$(function(){
		   	var control = $("#usercurriculumfile"); 
			control.fileinput({
			    language: 'zh', //设置语言
  ...
  <body>
		...
		<div class="row">
			...
			<div class="col-md-8" style="background: #fff; padding: 40px 80px; margin: 30px; border: 7px solid #ccc;">
				...
				<form id="myform" class="form-horizontal" action="userAction_batchAddUserCurriculum.action" method="post" style="margin-top: 5px" enctype="multipart/form-data">
					<div class="form-group from-inline">
						<label for="curriculum" class="col-sm-3 control-label">批量导入样表:</label>
						<div class="col-sm-5">
							<a class='btn btn-primary' id="usercurriculumexceldemo" href="userAction_downloadUserCurriculumExcelDemo.action">下载</a>
						</div>
					</div>
					<div class="form-group">
						<label for="usercurriculumfile" class="col-sm-3 control-label">请选择xls文件:</label>
						<div class="col-sm-5">
							<input id="usercurriculumfile" name="userCurriculumFile" type="file">
						</div>
					</div>
				</form>
	 		</div>
