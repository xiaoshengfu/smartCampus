  ...
  <body>
		...
		<div class="row">
			...
			<div class="col-md-8" style="background: #fff; padding: 40px 80px; margin: 30px; border: 7px solid #ccc;">
				...
				<form id="myform" class="form-horizontal" action="majorClassAction_batchAddMajorClass.action" method="post" style="margin-top: 5px" enctype="multipart/form-data">
					<div class="form-group from-inline">
						<label for="studentexceldemo" class="col-sm-3 control-label">批量导入样表:</label>
						<div class="col-sm-5">
							<a class='btn btn-primary' id="studentexceldemo" href="majorClassAction_downloadMajorClassExcelDemo.action">下载</a>
						</div>
					</div>
					<div class="form-group">
						<label for="majorclassfile" class="col-sm-3 control-label">请选择xls文件:</label>
						<div class="col-sm-5">
							<input id="majorclassfile" name="majorClassFile" type="file">
						</div>
					</div>
				</form>
	 		</div>
